...
charts='["zeebe-cluster-helm", "zeebe-operate-helm", "zeebe-full-helm", "zeebe-operator","zeebe-operator-cc", "zeebe-zeeqs-helm","zeebe-tasklist-helm", "zeebe-cloud-events-router", "tickets-service", "payments-service"]'
